...
{
    [BepInPlugin("com.barros.pizzacreator.ai", "Barro's AI Pizza Designer", "1.6.0")]
    ...
    public sealed class BarrosAiPlugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            Logger.LogInfo("Barro's AI Pizza Designer 1.6.0 loaded. Waiting for Pizza Creator services.");
        }
