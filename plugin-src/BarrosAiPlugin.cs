...
{
    [BepInPlugin("com.barros.pizzacreator.ai", "Barro's AI Pizza Designer", "1.3.0-rc1")]
    ...
    public sealed class BarrosAiPlugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            Logger.LogInfo("Barro's AI Pizza Designer 1.3.0-rc1 loaded. Waiting for Pizza Creator services.");
        }
